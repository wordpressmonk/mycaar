		...
		<?php if($program_id){ ?>				
				...
				'columns' => [
					...
					'checkboxOptions' => function ($model, $key, $index, $column){
						return ['checked' =>($model->isenrolled)?true:false ,'value'=>$model->id];
					}  				
					],					
						'username', 								
					 [
						'attribute' => 'isenrolled',
						'format' => 'html',
						'label' => 'Enrolled Status',					
						'filter' => Html::activeDropDownList($searchModel, 'isenrolled', [1=>'Enroll',0=>'UnEnrol'],['class'=>'form-control input-sm','prompt' => '--Enroll Status--']),
						'value' => function ($model, $key, $index, $column){
							return ($model->isenrolled)?'<i class="fa fa-check text-success"></i>':'<i class="fa fa-close text-danger"></i>';
